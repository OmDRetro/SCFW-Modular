...
- `cog.gba`
> [!TIP]
> Unlike Cologne, TheHiVE has implemented his own version of the Colecovision BIOS and embedded it in CoG so no external BIOS is needed.
...
- `cologne.gba`
> [!IMPORTANT]
> Cologne **REQUIRES** a Colecvision BIOS before you can use it. It will NOT work without it. Obtain any Colecovision BIOS and rename it to **[BIOS].col** then place it in the /scfw/ folder
